  ...
  return (
    <div className=" text-white">
      <div className="flex items-center gap-12">
        <h1 className="font-bold  text-xl m-3">KohaKu</h1>
        <div className="flex items-center">
          <h1 className="font-bold  text-xl ml-3 ">1.000.000 </h1>
          <h2 className="ml-1 text-xs">vnd</h2>
        </div>
      </div>
      <div className="bg-black h-[3px] w-[300px] mt-2" />
